...
public class EmployeeDAOImpl implements EmployeeDAOInterface {
    ...
    private static final String SEARCH_EMPLOYEES_BY_NAME_SQL = "SELECT id, firstname, lastname, email, country FROM employees WHERE id = ? OR (CONCAT(firstname, ' ', lastname) LIKE ?)";
    ...
    @Override
    public List<Employee> searchEmployeesByInput(String searchTerm) throws EmployeeDAOException {
        List<Employee> employees = new ArrayList<>();
        try (Connection connection = DatabaseConfigDAO.getConnection();
            ...
            throw new EmployeeDAOException("Error searching employees by input.", e);
        }
        return employees;
    }
