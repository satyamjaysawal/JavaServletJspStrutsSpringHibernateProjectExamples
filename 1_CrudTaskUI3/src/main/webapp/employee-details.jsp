    ...
    <div class="container mt-5">
        ...
        <c:if test="${employee != null}">
            <dl class="row">
                ...
                <dd class="col-sm-9"><c:out value="${employee.firstname} ${employee.lastname}" /></dd>
                ...
                <dd class="col-sm-9">
                    <span>Street Address:</span> <c:out value="${employee.address.streetAddress}" /><br>
                    <span>Apartment:</span> <c:out value="${employee.address.apartment}" /><br>
                    <span>City:</span> <c:out value="${employee.address.city}" /><br>
                    <span>State:</span> <c:out value="${employee.address.state}" /><br>
                    <span>Postal Code:</span> <c:out value="${employee.address.postalCode}" /><br>
                    <span>Landmark:</span> <c:out value="${employee.address.landmark}" />
                </dd>
